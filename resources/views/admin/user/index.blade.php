                                    ...
                                    <tbody>
                                        @foreach ($users as $key=>$value)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($value->is_admin == 0)
                                                        <div class="p-1 mb-1 bg-success text-white" style="text-align: center">Customer</div>
                                                    @else
                                                        <div class="p-1 mb-1 bg-danger text-white" style="text-align: center">Admin</div>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
