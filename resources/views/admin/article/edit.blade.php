                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit/Update Artikel</h3>
                            </div>
                            <form id="quickForm" method="POST" action="{{ url('article', [$article->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputBorder" name="judul" value="{{ $article->judul }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputBorder">Deskripsi Artikel</label>
                                        <textarea class="form-control" id="exampleInputBorder" name="deskripsi" >{{ $article->deskripsi }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputBorder" name="sumber">{{ $article->sumber }}</textarea>
                                    </div>
                                </div>
