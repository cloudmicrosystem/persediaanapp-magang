                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>{{ $barang->total() }} <small>Item</small></h3>
                            ...
                            <a href="barang" class="small-box-footer">Info lebih lanjut <i
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-gradient-blue">
                            <div class="inner">
                                <h3>{{ $order->total() }} <small>Transaksi</small></h3>

                                <p>Penjualan Morfeen</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-bag"></i>
                            </div>
                            <a href="penjualan" class="small-box-footer">Info lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>{{ $article->total() }} <small>Artikel</small></h3>
                            ...
                            <a href="article" class="small-box-footer">Info lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h3>{{ $users->total() }} <small>Customer</small></h3>

                                <p>Customer Morfeen</p>
                            </div>
                            <div class="icon">
                                <i class="ion ion-person-add"></i>
                            </div>
                            <a href="user" class="small-box-footer">Info lebih lanjut <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
